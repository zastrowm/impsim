...
public class TestRevoluteYPinCommand {
	...
	/**
	 * Test method for the Data YPin Command Constructor
	 * 
	 * Test method for
	 * {@link imp.core.commands.data.DataYPinCommand#DataYPinCommand(imp.core.structures.Point, imp.core.structures.Point, imp.core.structures.Point, java.lang.String)}
	 * 
	 ...
	 */
	@Test
	public void testDataYPinCommand() throws NullParameterException, InvalidParameterException, SelfLoopException {
		// [start] a sunny-day case
		RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, p1, p2, p3);
		// [end]
	}
	 ...
	 */
	@Test
	public void testDataYPinCommandCoexistingPoints0_1() throws NullParameterException, InvalidParameterException, SelfLoopException {
		this.thrown.expect(InvalidParameterException.class);
		RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, p1, p1, p3);
	}
	 ...
	 */
	@Test
	public void testDataYPinCommandCoexistingPoints0_2() throws NullParameterException, InvalidParameterException, SelfLoopException {
		this.thrown.expect(InvalidParameterException.class);
		RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, p1, p2, p1);
	}
	...
	@Ignore("TODO broken")
	@Test
	public void testDataYPinCommandCoexistingPoints1_2() throws NullParameterException, InvalidParameterException, SelfLoopException {
		this.thrown.expect(InvalidParameterException.class);
		RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, p1, p2, p2);
	}

	/**
	 * Test cases for the Data YPin Command's execute method.
	 * 
	...
	public void testExecute() throws NullParameterException, IMPException {
		...
		RevoluteCommand dypc = RevoluteCommand.CreateYPin("test", "body1", "body2", origin, p1, p2);

		dypc.execute(model);
		Revolute rev = (Revolute) model.getJoint("test");
		...
		assertTrue(model.getJoint("test") != null);

		// check that added joint is correct type
		assertEquals(Revolute.class, model.getJoint("test").getClass());
	}

	/**
	 * Test method for {@link imp.core.commands.data.DataYPinCommand#execute(imp.core.model.Model)}.
	 * 
	 * @throws InvalidParameterException
	 * @throws NullParameterException
	...
	public void testExecuteClosePoints() throws NullParameterException, InvalidParameterException, JointNotFoundException, InvalidDatatypeException,
		...
		Point P2 = new Point(x, 1, 0);
		Point P3 = new Point(60, 40, 0);

		// Expect an exception
		this.thrown.expect(InvalidParameterException.class);
		RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, origin, P2, P3);
	}

	/**
	 * Test method for {@link imp.core.commands.data.DataYPinCommand#equals(Object)}.
	 * 
	 * @throws InvalidParameterException
	 * @throws NullParameterException
	 * @throws SelfLoopException
	...
	public void testEquals() throws NullParameterException, InvalidParameterException, SelfLoopException {
		...
		RevoluteCommand dxc = RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, p1, p2, p3);
		RevoluteCommand dxc2 = RevoluteCommand.CreateYPin(jointName, bodyNameBefore, bodyNameAfter, p1, p2, p3);
