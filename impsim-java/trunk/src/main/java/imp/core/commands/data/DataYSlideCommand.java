...
/**
 * Class for instantiating the data in an YSlide joint to be something other than the default values. The execute method
 ...
 * @version 1.01
 */
public class DataYSlideCommand extends DataPrismCommand {
	 ...
	 *             malfunction.
	 */
	public DataYSlideCommand(Point origin, String jointName) throws NullParameterException, InvalidParameterException {
		super(origin, new Point(notNull(origin, 0).getX(), notNull(origin, 0).getY()+1, notNull(origin, 0).getZ()), new Point(
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof DataYSlideCommand)) {
			return false;
		} else {
			DataYSlideCommand otherCmd = (DataYSlideCommand) otherObject;
	...
	public String toString() {
		return "DataYSlideCommand [name=" + this.name + ", origin=" + this.origin + ", commonAxis=" + this.commonAxis + ", halfPlane=" + this.halfPlane + "]";
	}
}
