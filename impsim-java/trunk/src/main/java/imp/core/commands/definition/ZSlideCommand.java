...
/**
 * Class for implementing the command used to create an ZSlide joint to link together two bodies. The execute method
 ...
 * @version 1.01
 */
public class ZSlideCommand extends PrismCommand {
	 ...
	 * @param jointName The name of the ZSlide.
	 ...
	 */
	public ZSlideCommand(String bodyNameBefore, String bodyNameAfter, String jointName) throws NullParameterException, SelfLoopException {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof ZSlideCommand)) {
			return false;
		} else {
			ZSlideCommand otherCmd = (ZSlideCommand) otherObject;
	...
	public String toString() {
		return "ZSlideCommand [joint=" + this.jointName + ", bodyBefore=" + this.bodyNameBefore + ", bodyAfter=" + this.bodyNameAfter + "]";
	}
