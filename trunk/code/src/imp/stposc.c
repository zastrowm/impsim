...
* ------------------------------------------------------------------- */
/* ------------------------------------------------------------------ */
/* stposc-01 Jan 00:17 Mar 09
|     (C)Copyright, JJU Research, 2000-2009.
|
|     Description:
|       Write the requested position results on the store file.
|
|     Access:
|       (void) stposc(Token name[], int n);
...
|     position data cannot be found, no data is output.
*
*     History:
