...
* ------------------------------------------------------------------- */
/* ------------------------------------------------------------------ */
/* placc-01 Jan 00:17 Mar 09
|     (C)Copyright, JJU Research, 2000-2009.
|
|     Description:
|       Write the requested acceleration results on the plot file.
|
|     Access:
|       (void) placc(Token name[], int n);
...
*     12 Mar 09:JJU-Implemented Eutler parameters.
* ------------------------------------------------------------------- */
