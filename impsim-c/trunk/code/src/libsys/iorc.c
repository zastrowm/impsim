...
|
|     Description:
|       Form the bit by bit logical or of the bit patterns stored in
|     two words.
|
|     Access:
|       ireslt = (unsigned long) iorc(void *iword1, void *iword2);
...
#ifdef ANSI
  unsigned long iorc(void *iword1, void *iword2)
#else
  unsigned long iorc(iword1, iword2)
  void *iword1, *iword2;
#endif
{
